...
module.exports = {
    ...
    GIT : "www.instagram.com/alinafisse",
    WAGRP : 'www.instagram.com/alinafisse',
    ...
    FOOTER : process.env.FOOTER || "linda_x9",
    PASSWORD : process.env.PASSWORD || 'inrl-bot~md',
    WARNCOUND : process.env.WARNCOUND || 5,
    ALIVE_DATA : process.env.ALIVE_DATA || "$text>_iam alive now &sender_",
    BOT_INFO : process.env.BOT_INFO || "212720635640;INRL-BOT-MD;INRL;https://telegra.ph/file/c6ba7236049356210a8b5.jpg",
    ...
    CAPTION : process.env.CAPTION || "created by www.instagram.com/alinafisse",
    SUDO : process.env.SUDO || "212720635640"
};
